let {
 ...
 smd(
  ...
  async (message) => {
    const channelMessage = `LUMINA-TECHNOLOGIES' 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐖𝐇𝐀𝐓𝐒𝐀𝐏𝐏 𝐂𝐇𝐀𝐍𝐍E𝐋𝐄 𝐅𝐎𝐋𝐋𝐎𝐖 𝐑𝐄𝐐_\n *𝐋𝐈𝐍𝐊*:https://whatsapp.com/channel/0029VbAaQrP90x2qv23Lud3h\n\n ${Config.botname} *LuminaTech-V1*`;
...
smd(
  ...
  async (message) => {
    const SupportMsg = `LUMINA-TECHNOLOGIES 𝐎𝐅𝐅𝐈𝐂𝐀𝐋 𝐒𝐔𝐏𝐏𝐎𝐑𝐓 𝐆𝐑𝐎𝐔𝐏\n\n *ʟɪɴᴋ:*https://chat.whatsapp.com/CH4EiDyMLQ2EIH5FC9V6mr\n\n ${Config.botname} *WORKS*`;
